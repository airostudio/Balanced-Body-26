...
const heroImagePrompt = {
  ...
  prompt: `A heartwarming professional photograph of a happy older couple in their late 60s practicing authentic TAI CHI WALKING together in a beautiful sunlit park. IMPORTANT: This is TAI CHI, NOT YOGA - they are doing slow, deliberate walking movements with arms in flowing tai chi postures (like "cloud hands" or "grasp bird's tail" positions). They are walking side-by-side in synchronized slow-motion tai chi walking steps, both wearing comfortable earth-toned athletic clothing (soft beige and warm orange hues). The man has silver-gray hair and the woman has white hair in a short elegant style. They are smiling at each other, showing genuine connection and joy. Their posture shows classic tai chi stance: knees slightly bent, weight shifting smoothly, arms moving in circular flowing motions characteristic of tai chi (NOT yoga stretches or poses). The background shows a peaceful park with soft-focus trees and morning golden hour sunlight filtering through leaves. Professional lifestyle photography, shallow depth of field, warm and inviting atmosphere, natural colors, realistic photo showing healthy active aging, inspiring and achievable feeling. Focus on TAI CHI martial arts walking meditation, not yoga.`,
};
